Browser in Browser (BiB) is a website that allows you to run a browser directly in a browser. It uses PHP to detect which website will be displayed by HTML.
